				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="/">首頁 </a>  <span class="lnr lnr-arrow-right"></span>會員註冊</p>
						</div>	
					</div>
				</div>
			</section>
					...
					<div class="row justify-content-center">
						<div class="col-lg-5 sidebar-widgets mt-10 mb-10 ">
							<div class="widget-wrap">
                                <form class="single-sidebar-widget newsletter-widget" method="POST" action="{{ route('register') }}">
                                @csrf    
									<h4 class="newsletter-title">註冊會員</h4>
									<p>
									...
									<div class="col-autos">
										<div class="input-group">
											...
											<input type="text" class="form-control" id="inlineFormInputGroup" placeholder="輸入暱稱" onfocus="this.placeholder = ''" onblur="this.placeholder = '輸入暱稱'" name="name">
										</div>
										</div>
									</div>	
									<div class="form-group d-flex flex-row">
									<div class="col-autos">
										<div class="input-group">
											...
											<input type="text" class="form-control" id="inlineFormInputGroup" placeholder="輸入電話" onfocus="this.placeholder = ''" onblur="this.placeholder = '電話'" name="phonenumber">
										</div>
										</div>
									</div>	
									<div class="form-group d-flex flex-row">
									...
									<div class="col-autos">
										<div class="input-group">	
											...
											<input type="password" name="password" class="form-control" id="inlineFormInputGroup" placeholder="輸入密碼" onfocus="this.placeholder = ''" onblur="this.placeholder = '輸入密碼'" >
										</div>
										</div>
									</div>	
									<div class="form-group d-flex flex-row">
									<div class="col-autos">
										<div class="input-group">
											...
											<input type="password" name="password_confirmation" class="form-control" id="inlineFormInputGroup" placeholder="確認密碼" onfocus="this.placeholder = ''" onblur="this.placeholder = '確認密碼'" >
										</div>
										</div>
									</div>	
									<div class="button-group-area mt-10 form-group d-flex flex-row justify-content-start">
										<button type="submit" class="genric-btn success">註冊</button>	
									</div>
								</form>							
							</div>
						</div>
