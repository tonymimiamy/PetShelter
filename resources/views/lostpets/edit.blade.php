    		...
    		<section class="Volunteer-form-area section-gap">
				<div class="container">
					...
					<div class="row justify-content-center">
                        <form method="post" action="/lostpets/{{ $pet->lostpet->lost_pet_id }}" class="col-lg-9" enctype="multipart/form-data">
                            @csrf
						  ...
						  <div class="form-row">
						  		...
						  		<label for="Country">是否結紮</label>
						   		<div class="select-option" id="service-select">
									<select>
										...
										<option @if(isset($pet)&&$pet['animal_ligation']=="未結紮") selected @endif value="未結紮">未結紮</option>
									</select>
								</div>	
						  	</div>					  	
						  	<div class="col-6 mb-30">
                            ...
                            <div class="col-6 mb-30">
						  		<label for="phone">走失時間</label>
						   		<input name="lost_time" value="{{ $lostpet->lost_time }}" type="text" class="form-control" placeholder="走失時間">						  		
                            </div>
                            <div class="col-6 mb-30">
						  		<label for="phone">走失地點</label>
						   		<input name="lost_place" value="{{ $lostpet->lost_place }}" type="text" class="form-control" placeholder="走失地點">						  		
						  	</div>  			  	
						  </div>		
						  <div class="form-group">
