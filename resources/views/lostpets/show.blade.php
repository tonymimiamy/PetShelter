                ...
                <div class="single-post row">
                    <div class="col-lg-12">
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-list media">
                                <div class="single-comment justify-content-between d-flex">
                                    ...
                                    <button type="button" class="close" onclick="deleteLostComment(event)"data-action="/lostpets/show/{{ $comment->id }}" aria-label="Close">
                        ...
                        <div class="comment-form">
                            <h4>留言板</h4>
                            <form method="post" action="/lostpetsComment">
                                @csrf
                                <input type="hidden" name="pet_id" value="{{ $pet->lostpet->pet_id }}">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control mb-10" rows="5" name="comment"  required placeholder="留言" onfocus="this.placeholder = ''" onblur="this.placeholder = '留言'"></textarea>
                                </div>
                ...
                <div class="col-lg-4 sidebar-widgets">
                    <div class="widget-wrap">
                        <div class="single-sidebar-widget post-category-widget">
                            ...
                            <ul class="cat-list">
                                ...
                                <li>
                                    <a href="#" class="d-flex justify-content-between">
                                        <p>走失時間</p>
                                        <p>{{ $lostpet->lost_time }}</p>
                                    </a>
                                </li>	
                                <li>
                                    <a href="#" class="d-flex justify-content-between">
                                        <p>走失地點</p>
                                        <p>{{ $lostpet->lost_place }}</p>
                                    </a>
                                </li>																
                            </ul>
                        </div>	
                        ...
                        <div class="single-sidebar-widget user-info-widget">
                            <div class="thumb">
                                <img src="{{ $lostpet->user->user_img }}" alt="">    
                            </div>                            
                            <h4 class="mt-10">聯絡人：{{ $lostpet->user->name }}</h4>
                            <h4 class="mt-10 mb-20">{{ $lostpet->user->phonenumber }}</h4>                            
                        </div>
                        @endguest
